...
val DarkPaletteColors = darkColors(
    primary = AppBrandColor.PrimaryDarkColor,
    primaryVariant = AppBrandColor.PrimaryColor,
    secondary = AppBrandColor.SecondaryDarkColor,
...
val LightPaletteColors = lightColors(
    ...
    primaryVariant = AppBrandColor.PrimaryLightColor,
    secondary = AppBrandColor.SecondaryColor,
    secondaryVariant = AppBrandColor.SecondaryLightColor,
